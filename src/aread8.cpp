            ...
            while (!que.empty())
            {
                ...
                } else
                {
                    if (flowData->isNodata(i, j))
                        cout <<
                        "Warning: evaluating at location (most likely specified outlet) where flow direction is undefined. i = " <<
                        i << ", j = " << j << ", rank = " << rank << endl;
                    else
                        cout << "Warning: Invalid flow direction = " << k << " encountered at i = " << i << ", j = " <<
                        j << ", rank = " << rank << endl;
                }
            }
