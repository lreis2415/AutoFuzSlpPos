...
int netexC(short **dir, int **area, char *treefile, char *coordfile, char *ordfile, int nx, int ny, int itresh,
           int icr, int &icend, double dx, double dy, double *bndbox, double csize, int filetype, int err,
           short *inodes,
...
int gridstat(char *grdname /*Path to grid to compute statistics*/, char *idgrid/*Path to the idgrid (sampling region)*/,
             long ind, double *statlist/*this array hold all the statistics information*/);
