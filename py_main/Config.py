...
if rpiFile is None:
    TerrainAttrDict = {'RPI': RPI_default_path, 'ProfC': ProfC_default_path, 'Slope':Slope_default_path, 'HAND':HAND_default_path}
else:
...
if AutoInfParams:
    ...
    RdgInferenceInfo = [['RPI','S',0.1,2,0.5,1,0,1],['ProfC','S',0.005,2,0.5,1,0,1],['Slope','Z',1,0,1,5,2,0.5],['HAND','S',5,2,0.5,1,0,1]]
