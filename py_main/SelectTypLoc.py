...
if __name__ == '__main__':
    ...
    SelectTypLoc()
    # TypLocItems = [
    #     ["rdg", RdgExtConfig, RdgTyp, RdgTag, RdgExtractionInfo, DistanceExponentForIDW, RdgInf, RdgInfRecommend,
    #      RdgExtLog, RdgFuzInfDefault, RdgTerrainRestrict, RdgBaseParam],
    #     ["shd", ShdExtConfig, ShdTyp, ShdTag, ShdExtractionInfo, DistanceExponentForIDW, ShdInf, ShdInfRecommend,
    #      ShdExtLog, ShdFuzInfDefault, ShdTerrainRestrict, ShdBaseParam],
    #     ["bks", BksExtConfig, BksTyp, BksTag, BksExtractionInfo, DistanceExponentForIDW, BksInf, BksInfRecommend,
    #      BksExtLog, BksFuzInfDefault, BksTerrainRestrict, BksBaseParam],
    #     ["fts", FtsExtConfig, FtsTyp, FtsTag, FtsExtractionInfo, DistanceExponentForIDW, FtsInf, FtsInfRecommend,
    #      FtsExtLog, FtsFuzInfDefault, FtsTerrainRestrict, FtsBaseParam],
    #     ["vly", VlyExtConfig, VlyTyp, VlyTag, VlyExtractionInfo, DistanceExponentForIDW, VlyInf, VlyInfRecommend,
    #      VlyExtLog, VlyFuzInfDefault, VlyTerrainRestrict, VlyBaseParam]]
    #
    ...
    #         ExtconfigInfo.write(baseInputParam)
    #         ExtconfigInfo.close()
    #     #TauDEM.SelectTypLocSlpPos(item[1], item[7], inputProc, item[8], mpiexeDir, exeDir,hostfile)
    # print "Typical Locations Selected Done!"
